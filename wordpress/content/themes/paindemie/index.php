      ...
      <div class="row">
        ...
        <div class="col-lg-7 col-md-12 col-sm-12 imagesStudio text-center">
          ...
          <div class="StudioButton">
            <a href="<?php bloginfo('url'); ?>/equipement/" type="button" class="btn btn-primary customButton">Voir les equipements </button></a>
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-12 col-sm-12 bottom">
        <div class='row'>
          ...
          <a href="<?php bloginfo('url'); ?>/contact/" type="button" class="btn btn-primary customButton">Consultez nos references</button></a>
          </div>
        </div>
      </div>
    </div>
